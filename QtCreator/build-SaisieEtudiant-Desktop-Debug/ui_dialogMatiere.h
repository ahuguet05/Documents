...
public:
    ...
    QLabel *label_2;
    QLineEdit *lineEditCoeffMatiere;
    ...
    void setupUi(QDialog *DialogMatiere)
    {
        ...
        label_2 = new QLabel(DialogMatiere);
        label_2->setObjectName(QString::fromUtf8("label_2"));

        horizontalLayout->addWidget(label_2);

        lineEditCoeffMatiere = new QLineEdit(DialogMatiere);
        lineEditCoeffMatiere->setObjectName(QString::fromUtf8("lineEditCoeffMatiere"));

        horizontalLayout->addWidget(lineEditCoeffMatiere);
    ...
    void retranslateUi(QDialog *DialogMatiere)
    {
        ...
        label->setText(QApplication::translate("DialogMatiere", "Nom Matiere:", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("DialogMatiere", "Coeff: ", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
