...
drop table if exists pointRelaisParUtilisateur;
...
create table lot(
	lotNum int,
	lotModeDeProd bool, -- 0:pas bio 1:bio
	lotDateRecolte date,
...
create table utilisateur(
	...
	utiRue varchar(20),
	utiCP varchar(5),
	utiCommuneLibelle varchar(50),
	utiEmail varchar(30),
	utiPseudo varchar(30),
	utiMDP varchar(40),
	utiCle varchar(20),
	utiValidationEmail bool,
	utiDateInscription date,
	PRIMARY KEY (utiNum)
)engine=innodb default charset=utf8;

create table pointRelaisParUtilisateur(
	utiNum int,
	relNum int,
	PRIMARY KEY (utiNum,relNum)
)engine=innodb default charset=utf8;
...
alter table pointRelaisParUtilisateur
	add foreign key (utiNum) references utilisateur(utiNum),
...
alter table produit
	add foreign key (typeId) references typeProd(typeId),
	add foreign key (rayonId) references typeProd(rayonId);
